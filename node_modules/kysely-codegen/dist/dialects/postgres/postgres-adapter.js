...
class PostgresAdapter extends core_1.Adapter {
    constructor() {
        ...
        this.scalars = {
            ...
            bool: new ast_1.IdentifierNode('boolean'),
            box: new ast_1.IdentifierNode('string'),
            bpchar: new ast_1.IdentifierNode('string'),
            ...
            float4: new ast_1.IdentifierNode('number'),
            float8: new ast_1.IdentifierNode('number'),
            inet: new ast_1.IdentifierNode('string'),
            int2: new ast_1.IdentifierNode('number'),
            int4: new ast_1.IdentifierNode('number'),
            int8: new ast_1.IdentifierNode('Int8'),
            ...
            oid: new ast_1.IdentifierNode('number'),
            ...
            varbit: new ast_1.IdentifierNode('string'),
