...
class LibSqlDialect extends core_1.Dialect {
    constructor() {
        ...
        this.introspector = new libsql_introspector_1.SqliteIntrospector();
    }
    async createKyselyDialect(options) {
        const { LibsqlDialect } = await Promise.resolve().then(() => __importStar(require('@libsql/kysely-libsql')));
